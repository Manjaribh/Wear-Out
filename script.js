                ...
                .then(data => {
                    ...
                    function changeWeatherIcons() {
                        if ([1, 2, 30].includes(iconNumber)) {
                            mainWeatherIcon.attr("src", "svg-icon-weather-sun.svg");
                            secondaryWeatherIcon.attr("src", "svg-icon-weather-sun.svg");
                        } else if ([3, 4].includes(iconNumber)) {
                            mainWeatherIcon.attr("src", "svg-icon-weather-sun.svg");
                            secondaryWeatherIcon.attr("src", "svg-icon-weather-mostly-cloud.svg");
                        } else if ([5, 6].includes(iconNumber)) {
                            mainWeatherIcon.attr("src", "svg-icon-weather-mostly-cloud.svg");
                            secondaryWeatherIcon.attr("src", "svg-icon-weather-mostly-cloud.svg");
                        } else if ([7, 8].includes(iconNumber)) {
                            mainWeatherIcon.attr("src", "svg-icon-weather-cloud.svg");
                            secondaryWeatherIcon.attr("src", "svg-icon-weather-cloud.svg");
                        } else if (iconNumber === 11) {
                            mainWeatherIcon.attr("src", "svg-icon-weather-fog.svg");
                            secondaryWeatherIcon.attr("src", "svg-icon-weather-fog.svg");
                        } else if ([12, 18].includes(iconNumber)) {
                            mainWeatherIcon.attr("src", "svg-icon-weather-rain.svg");
                            secondaryWeatherIcon.attr("src", "svg-icon-weather-rain.svg");
                        } else if ([13, 14].includes(iconNumber)) {
                            mainWeatherIcon.attr("src", "svg-icon-weather-mostly-cloud.svg");
                            secondaryWeatherIcon.attr("src", "svg-icon-weather-rain.svg");
                        } else if (iconNumber === 15) {
                            mainWeatherIcon.attr("src", "svg-icon-weather-storm.svg");
                            secondaryWeatherIcon.attr("src", "svg-icon-weather-storm.svg");
                        } else if ([16, 17].includes(iconNumber)) {
                            mainWeatherIcon.attr("src", "svg-icon-weather-mostly-cloud.svg");
                            secondaryWeatherIcon.attr("src", "svg-icon-weather-storm.svg");
                        } else if (iconNumber === 19) {
                            mainWeatherIcon.attr("src", "svg-icon-weather-sleet.svg");
                            secondaryWeatherIcon.attr("src", "assets/images/weather-icons/svg-icon-weather-cloud.svg");
                        } else if ([20, 21].includes(iconNumber)) {
                            mainWeatherIcon.attr("src", "svg-icon-weather-mostly-cloud.svg");
                            secondaryWeatherIcon.attr("src", "svg-icon-weather-sleet.svg");
                        } else if (iconNumber === 22) {
                            mainWeatherIcon.attr("src", "svg-icon-weather-snow.svg");
                            secondaryWeatherIcon.attr("src", "svg-icon-weather-snow.svg");
                        } else if (iconNumber === 23) {
                            mainWeatherIcon.attr("src", "svg-icon-weather-mostly-cloud.svg");
                            secondaryWeatherIcon.attr("src", "svg-icon-weather-snow.svg");
                        } else if ([24, 31].includes(iconNumber)) {
                            mainWeatherIcon.attr("src", "svg-icon-weather-ice.svg");
                            secondaryWeatherIcon.attr("src", "svg-icon-weather-ice.svg");
                        } else if ([25, 26, 29].includes(iconNumber)) {
                            mainWeatherIcon.attr("src", "svg-icon-weather-sleet.svg");
                            secondaryWeatherIcon.attr("src", "svg-icon-weather-sleet.svg");
                        } else if (iconNumber === 32) {
                            mainWeatherIcon.attr("src", "svg-icon-weather-wind.svg");
                            secondaryWeatherIcon.attr("src", "svg-icon-weather-wind.svg");
                        } else {
                            mainWeatherIcon.attr("src", "svg-icon-went-wrong.svg");
                            secondaryWeatherIcon.attr("src", "svg-icon-went-wrong.svg");
                        }
                    }
                    changeWeatherIcons();
                    ...
                    function populateProducts(productsArray) {
                        ...
                        productsArray[2].attr("src", `C:\Users\Manjari\Desktop\WEB_DEV_PROJ\clothes-items${productsArray[4]}/${productsArray[3]}.png`);
                    };
                    ...
                    function changeClothesIcons() {
                        ...
                        function changeClothesIconsTop() {
                            if (maxTemperatureResult <= 20) {
                                clothesIconTop.attr("src", "svg-icon-clothes-shirt.svg");
                                ...
                                clothesIconTop.attr("src", "svg-icon-clothes-tshirt.svg");
                        ...
                        function changeClothesIconsBottom() {
                            if (maxTemperatureResult > 24) {
                                clothesIconBottom.attr("src", "svg-icon-clothes-shorts.svg");
                                ...
                                clothesIconBottom.attr("src", "svg-icon-clothes-pants.svg");
                        ...
                        function changeClothesIconsFootwear() {
                            if (maxTemperatureResult > 26) {
                                clothesIconFootwear.attr("src", "svg-icon-clothes-sandal.svg");
                                ...
                                clothesIconFootwear.attr("src", "svg-icon-clothes-shoe.svg");
                        ...
                        function changeClothesIconsFootwearBoots() {
                            if ((iconNumber >= 19 && iconNumber <= 26) || (iconNumber === 29)) {
                                clothesIconFootwear.attr("src", "svg-icon-clothes-boot.svg");
                        ...
                        function changeClothesIconsOuterwear() {
                            if (maxTemperatureResult <= 17) {
                                clothesIconOuterwear.attr("src", "svg-icon-clothes-jacket.svg");
                                ...
                                clothesIconOuterwear.attr("src", "svg-icon-clothes-hat.svg");
                                ...
                                clothesIconOuterwear.attr("src", "svg-icon-clothes-blazer.svg");
                        ...
                        function changeClothesIconsAdditional() {
                            if (maxTemperatureResult < 15) {
                                clothesIconAdditional.attr("src", "svg-icon-clothes-winter-hat.svg");
                                ...
                                clothesIconAdditional.attr("src", "svg-icon-clothes-sunglasses.svg");
                                ...
                                clothesIconAdditional.attr("src", "svg-icon-clothes-socks.svg");
                        ...
                        function changeClothesIconsAdditionalUmbrella() {
                            if ((iconNumber >= 12 && iconNumber <= 23) || [25, 26, 29].includes(iconNumber)) {
                                clothesIconAdditional.attr("src", "svg-icon-clothes-umbrella.svg");
